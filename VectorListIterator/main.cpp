...
public:
    ...
    public:
        ...
        bool operator == (const const_iterator cIt) {
            return cIt.data_ == data_ ? true : false;
        }
    ...
    const_iterator end() const {
        return const_iterator(--data_.end(), (--data_.end())->end());
    }

    using const_reverse_iterator = std::reverse_iterator<const_iterator>;
    const_reverse_iterator rbegin() const { return const_reverse_iterator(data_.end(), data_.end()->end()) ; }
    const_reverse_iterator rend()   const { return --data_.begin(), (--data_.begin())->begin() ; }
